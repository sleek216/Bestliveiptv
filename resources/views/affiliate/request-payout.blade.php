            ...
            <div class="col-lg-8">
                ...
                <div class="balance-card" data-aos="fade-up">
                    <div class="balance-content">
                        <div class="balance-info">
                            ...
                            <span class="balance-amount">${{ number_format($affiliate->available_balance, 2) }}</span>
                        </div>
                ...
                @if(!$affiliate->canRequestPayout())
                    ...
                    <div class="feature-card" style="background: rgba(239, 68, 68, 0.05); border: 2px solid rgba(239, 68, 68, 0.2);" data-aos="fade-up">
                        ...
                        <p class="feature-desc">
                            You need <strong>${{ number_format(max(0, \App\Models\Setting::get('affiliate_minimum_payout', 50) - $affiliate->available_balance), 2) }}</strong> more to request a payout.
                ...
                @else
                    ...
                    <div class="feature-card" data-aos="fade-up" data-aos-delay="100">
                        <form action="{{ route('affiliate.payouts.submit') }}" method="POST">
                            @csrf
                            ...
                            <div class="form-group">
                                ...
                                <div class="input-group-custom">
                                    ...
                                    <input type="number" 
                                           ...
                                           value="{{ old('amount', $affiliate->available_balance) }}"
                                           required
                                ...
                                @enderror
                                <small class="form-hint">Maximum: ${{ number_format($affiliate->available_balance, 2) }}</small>
                            </div>
