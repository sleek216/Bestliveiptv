                    ...
                    <div class="card-body">
                        ...
                        <div class="row">
                            <div class="col-md-4 mb-3">
                                ...
                                <input type="number" class="form-control @error('duration_months') is-invalid @enderror" id="duration_months" name="duration_months" value="{{ old('duration_months') }}">
                            ...
                            <div class="col-md-4 mb-3">
                                ...
                                <input type="number" class="form-control @error('duration_days') is-invalid @enderror" id="duration_days" name="duration_days" value="{{ old('duration_days') }}">
                                @error('duration_days')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                            <div class="col-md-4 mb-3">
                                ...
                                <input type="text" class="form-control @error('duration_label') is-invalid @enderror" id="duration_label" name="duration_label" value="{{ old('duration_label') }}" placeholder="e.g., 1 Month">
                        ...
                        <div class="row">
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="number" class="form-control @error('connections') is-invalid @enderror" id="connections" name="connections" value="{{ old('connections', 1) }}" required min="1">
                                @error('connections')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
