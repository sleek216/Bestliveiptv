...
@section('content')
    <div class="mb-4 d-flex flex-wrap justify-content-between align-items-center gap-3">
        <div class="d-flex align-items-center gap-3">
            ...
            <form action="{{ route('admin.dashboard') }}" method="GET" class="ms-4" id="filterForm">
                <select name="filter" class="form-select" onchange="document.getElementById('filterForm').submit()">
                    ...
                    <option value="14_days" {{ $filter == '14_days' ? 'selected' : '' }}>Last 14 Days (2 Weeks)</option>
                    ...
                    <option value="2_months" {{ $filter == '2_months' ? 'selected' : '' }}>Last 2 Months</option>
        ...
        <div class="col-md-6 col-xl-3">
            <div class="stat-card">
                ...
                <div class="stat-label">
                    @if($filter == 'all_time') Total Revenue @else Revenue ({{ str_replace('_', ' ', ucfirst($filter)) }}) @endif
                </div>
            </div>
        </div>
        <div class="col-md-6 col-xl-3">
            <div class="stat-card green">
                ...
                <div class="stat-label">
                    @if($filter == 'all_time') Total Orders @else Orders ({{ str_replace('_', ' ', ucfirst($filter)) }}) @endif
                </div>
            </div>
        </div>
        <div class="col-md-6 col-xl-3">
