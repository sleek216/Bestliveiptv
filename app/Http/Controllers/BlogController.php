...
class BlogController extends Controller
{
    ...
    public function index(): View
    {
        ...
        $featuredPost = Blog::active()->featured()->first();
        if (!$featuredPost) {
            $featuredPost = Blog::active()->orderBy('published_at', 'desc')->first();
        }
    ...
    {
        $this->ensureTableExists();
        $post = Blog::active()->where('slug', $slug)->firstOrFail();
