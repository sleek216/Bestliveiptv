...
class AuthController extends Controller
{
    ...
    public function sendResetLink(Request $request): RedirectResponse
    {
        ...
        try {
            ...
            return back()->withErrors([
                'email' => 'Unable to send password reset email. Please check your mail/SMTP server settings or contact support.'
    ...
    public function resetPassword(Request $request): RedirectResponse
    {
        ...
        try {
            ...
            return back()->withErrors(['email' => 'An error occurred during password reset: ' . $e->getMessage()]);
        }
    }
    ...
    public function register(Request $request): RedirectResponse
    {
        ...
        if ($referralCode) {
            $affiliateService->trackReferral($referralCode, $user);
        }
    ...
    public function showProfile(): View
    {
        ...
        if (Schema::hasColumn('orders', 'user_seen_at')) {
            $userUnreadOrdersCount = $user->orders()->whereNull('user_seen_at')->count();
            $user->orders()->whereNull('user_seen_at')->update(['user_seen_at' => now()]);
        }
        ...
        return view('auth.profile', compact('user', 'orders', 'affiliate', 'stats', 'userUnreadOrdersCount'));
    }
